...
- enable the ai to break down the prompt into TODO lists following a standardized format
  ...
  - [ ] Create a standardized task schema in `src/common_types/task_types.py` with fields for description, priority, dependencies, and status
  ...
  - [ ] Create unit tests in `tests/unit/test_task_breakdown.py` to verify breakdown functionality
